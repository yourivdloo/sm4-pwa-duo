...
class ListView extends Component {
  ...
  sortByLocation(location, items) {
    items.sort((a, b) => {
      ...
      var distance1 = (Math.sqrt(Math.abs(longDifference1 * longDifference1) + (Math.abs(latDifference1 * latDifference1)))) 
      var distance2 = (Math.sqrt(Math.abs(longDifference2 * longDifference2) + (Math.abs(latDifference2 * latDifference2))))
